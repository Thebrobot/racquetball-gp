...
export const lbData: LbData = {
	singles: {
		'open-men': [
			...
			{ name: 'Marcus Liu', city: 'Jacksonville, FL', s1: 25, s2: 50, status: 'pace' },
			{ name: 'Andre Simmons', city: 'Gainesville, FL', s1: 10, s2: 25, status: 'chase' },
			{ name: 'Kevin Torres', city: 'Tallahassee, FL', s1: 0, s2: 10, status: 'chase' },
			{ name: 'Brian Holloway', city: 'St. Pete, FL', s1: 10, s2: 0, status: 'chase' },
			{ name: 'James Whitfield', city: 'Ocala, FL', s1: 0, s2: 10, status: 'chase' },
		],
		'open-women': [
			{
				name: 'Sofia Reyes',
			...
			{ name: 'Maria Vega', city: 'Boca Raton, FL', s1: 50, s2: 25, status: 'pace' },
			{ name: 'Tamara Ellis', city: 'Fort Lauderdale, FL', s1: 10, s2: 10, status: 'chase' },
		],
		'a-men': [
			{ name: 'Rob Castillo', city: 'Tampa, FL', s1: 100, s2: 50, status: 'q' },
			{ name: 'Sam Wheeler', city: 'Miami, FL', s1: 50, s2: 75, status: 'q' },
			{ name: 'Jaylen Ford', city: 'Orlando, FL', s1: 75, s2: 10, status: 'pace' },
			{ name: 'Pete Nakamura', city: 'Sarasota, FL', s1: 25, s2: 25, status: 'chase' },
		],
	},
	doubles: {
		'open-men': [
			{ name: 'Mendez / Brooks', city: 'Miami & Orlando', s1: 80, s2: 80, status: 'q', note: 'Same partner' },
			{ name: 'West / Liu', city: 'Tampa & Jacksonville', s1: 40, s2: 60, status: 'q', note: 'Same partner' },
			{ name: 'Torres / Simmons', city: 'Tallahassee & Gainesville', s1: 65, s2: 0, status: 'pace' },
			{ name: 'Holloway / Whitfield', city: 'St. Pete & Ocala', s1: 0, s2: 65, status: 'pace' },
		],
	},
	mixed: {
		'open-men': [
